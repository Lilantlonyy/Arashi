 ...
 * @project_name : Arashi
 * @author : @Hridoy0016 <https://github.com/Hridoy0016>
 * @description : Arashi,A Multi-Anime Themed WhatsApp Bot.
 * @version 1.0.0
 **/
...
cmd(
  ...
  async (Void,citel,text,{isCreator}) => {
        ...
        delete this.game
        return citel.reply(`_Successfully exited running TicTacToe game._`);
        } else {
...
❌:- @${room.game.playerX.split("@")[0]}`;
      ...
      if ((room.game._currentTurn ^ isSurrender ? room.x : room.o) !== citel.chat)
        ...
        if(isWin){
        await eco.give(citel.sender, "Arashi", 2000);
        }
      if (isWin || isTie) {
